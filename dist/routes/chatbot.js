...
const firebase_1 = __importDefault(require("../firebase")); // Import the initialized admin SDK
const zod_1 = require("zod");
const router = express_1.default.Router();
// Zod schema for input validation, now with a stream option
const chatbotRequestSchema = zod_1.z.object({
    mensagemUsuario: zod_1.z.string()
    ...
    uid: zod_1.z.string().min(1).max(128), // Add min/max to UID as well for basic validation
    stream: zod_1.z.boolean().optional().default(false), // Option to request a streaming response
